...
namespace image
{
    public partial class MyPaint : Form
    {
        ...
        {
            Tekst, Linia, Prostokat, Elipsa, Olowek, Pedzel, Gumka, Kroplomierz
        }
        ...
        private void pictureBox_MouseDown(object sender, MouseEventArgs e)
        {
            if (e.Button == MouseButtons.Left)
            {
                ...
                else if (e.Button == MouseButtons.Left && wybor == Narzedzie.Kroplomierz)
                {
                    Bitmap nowaBmp = new Bitmap(pictureBox.Image);
                    Color pobranyKolor = nowaBmp.GetPixel(e.X, e.Y);

                    if (radioButton1.Checked)
                    {
                        setPaintColor = pobranyKolor;
                        pictureBox1.BackColor = setPaintColor;
                    }
                    else
                    {
                        setPaintColorFill = pobranyKolor;
                        pictureBox2.BackColor = setPaintColorFill;
                    }
        ...
        #region Kształty, gumka, kroplomierz - przyciski
        // Rysowanie linii
        ...
        #region Zamiana kolorow linii i wypełnienia
        private void button2_Click(object sender, EventArgs e)
        {
            Color tmp = setPaintColorFill;
            setPaintColorFill = setPaintColor;
            setPaintColor = tmp;
